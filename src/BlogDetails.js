...
const BlogDetails = () => {
  ...
  return (
    <div className="main">
      {filteredProductsArray.map((blogs) => (
                ...
                <div className="blog__details__content">
                  ...
                  <div className="blog__details__text">
                    <p>
                      ...
                      This cream nourishes the skin and brings back the glow
                    ...
                    <p>
                      ...
                      the skin. The other important ingredient, making hydroderm
                      so effective is “marine collagen” which along with
                  ...
                  <div className="blog__details__text">
                    <p>
                      ...
                      circles, puffiness, and crow’s feet can be control from
                      the strong effects of this serum.
                    </p>
                    <p>
                      ...
                      the wrinkles and all signs of aging from the sensitive
                      near the eyes.
                    </p>
                  </div>
